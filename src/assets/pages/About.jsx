            ...
            <div>
                ...
                <div className="container my-4">
                    <div className="col-md-8">
                        ...
                        {/* <div className="">
                            <Image src={`http://localhost:8081/download?fileName=${pageContent.imageName}`} rounded style={{ width: '100%' }} />

                        </div> */}

                        <article className="blog-post">
                            <h2 className="display-5 link-body-emphasis mb-1">Content</h2>
                            <p className="blog-post-meta">date<a href="#">Mark</a></p>
                ...
                <div className="" style={{ cursor: 'pointer', padding: '10px', borderTop: '1px solid lightgrey',borderBottom: '1px solid lightgrey' }}>
                    <div className="p-3 ">
                        <div className="container py-3 d-flex justify-content-between align-items-center" onClick={(e) => handleClick(e)}>
                            <h1 className="text-body-emphasis" style={{ fontSize: '69px' }}>Start reading</h1>
                            <div >
                                <FaArrowRight style={{ fontSize: '45px' }} />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="" style={{ cursor: 'pointer', padding: '10px',borderTop: '1px solid lightgrey', borderBottom: '1px solid lightgrey' }}>
                    <div className="p-3 ">
                        <div className="container py-3 d-flex justify-content-between align-items-center" onClick={handleShow}>
                            <h1 className="text-body-emphasis" style={{ fontSize: '69px' }}>Start writting</h1>
                            <div >
                                <FaArrowRight style={{ fontSize: '45px' }} />
                            </div>
                        </div>
