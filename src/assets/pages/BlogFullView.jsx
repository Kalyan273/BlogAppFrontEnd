...
const BlogFullView = () => {
    ...
    const pageContent = location.state;
                ...
                <div className="container my-4">
                    <div className="col-md-8">
                        ...
                        <article className="blog-post">
                            <h2 className="display-5 link-body-emphasis mb-1">{pageContent.title}</h2>
                            <p className="blog-post-meta">{pageContent.addedDate} by <a href="#">Mark</a></p>
